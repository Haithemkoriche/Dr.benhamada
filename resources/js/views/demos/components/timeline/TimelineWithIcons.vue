    ...
    <VTimeline align="start" line-inset="19" truncate-line="start" justify="center"
      ...
      <VTimelineItem fill-dot size="small">
        ...
        <VCard class="mb-10 mt-n4">
          <VCardItem class="pb-4">
            <VCardTitle>You've uploaded doc pdf to the WEBGENIUS project</VCardTitle>
          </VCardItem>
          <VCardText>
            <!-- 👉 Content -->
            <p class="app-timeline-text mb-3">
              ...
              it
              successfully. Simply put, it's an umbrella term which includes all the documents created over the course
              of the
              project.
            </p>
      ...
      <VTimelineItem fill-dot size="small">
        ...
        <VCard class="mb-10 mt-n4">
          <VCardItem class="pb-4">
            <VCardTitle>
              Loretta write a review on WEBGENIUS
            </VCardTitle>
          </VCardItem>
          <VCardText>
            <div>
              ...
              <div class="text-body-1">
                ...
                make
                the template better. I am so thankful for this. Also, in the past, they had responded well to my
                tickets.
                Thank you for this great theme, for such an amazing support, for the better updates. I wish I could rate
                this
                for so many times. I highly recommend this template!
              </div>
            </div>
          </VCardText>
        </VCard>
        ...
        <VCard class="mb-10 mt-n4">
          ...
          <VCardText>
            <p class="mb-3">
              ...
              corporate
              objectives and therefore also project objectives. The components of the project process are
            </p>
